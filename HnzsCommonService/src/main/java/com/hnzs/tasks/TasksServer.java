...
public class TasksServer{
    public static void main(String args[]){
        ...
        taskData.put("taskName","测试任务");
        taskData.put("taskBelogFlow","htt://localost/9210/test");
        taskData.put("taskStartTime","2021-10-29 22:17:00");
        taskData.put("taskEndTime","2021-10-29 22:18:00");
        //taskData.put("taskCrossDay","0");
        //taskData.put("taskCycleTime","[1,2,3,4,5,6,7]");
        //taskData.put("taskCycleEndTime","2021-10-24 09:07:00");
        taskData.put("taskIsTranscode","1");
        ...
        taskData.put("taskName","测试任务");
        taskData.put("taskBelogFlow","htt://localost/9210/test");
        taskData.put("taskStartTime","2021-10-29 16:10:00");
        taskData.put("taskEndTime","2021-10-29 16:45:00");
        //taskData.put("taskCrossDay","0");
        //taskData.put("taskCycleTime","[1,2,3,4,5,6,7]");
        //taskData.put("taskCycleEndTime","2021-10-24 09:07:00");
        taskData.put("taskIsTranscode","1");
        ...
        taskData.put("taskName","测试任务");
        taskData.put("taskBelogFlow","htt://localost/9210/test");
        taskData.put("taskStartTime","2021-10-29 16:06:00");
        taskData.put("taskEndTime","2021-10-29 16:10:00");
        //taskData.put("taskCrossDay","0");
        //taskData.put("taskCycleTime","[1,2,3,4,5,6,7]");
        //taskData.put("taskCycleEndTime","2021-10-24 09:07:00");
        taskData.put("taskIsTranscode","1");
